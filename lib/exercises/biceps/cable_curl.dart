...
class WorkoutCableCurlDetails extends StatefulWidget {
  const WorkoutCableCurlDetails({Key? key}) : super(key: key);

  @override
  _WorkoutCableCurlDetailsState createState() =>
      _WorkoutCableCurlDetailsState();
}

class _WorkoutCableCurlDetailsState extends State<WorkoutCableCurlDetails> {
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Curl the bar up until your forearms touch your chest.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
