...
class WorkoutBarbellOverheadPressDetails extends StatefulWidget {
  const WorkoutBarbellOverheadPressDetails({Key? key}) : super(key: key);

  @override
  _WorkoutBarbellOverheadPressDetailsState createState() =>
      _WorkoutBarbellOverheadPressDetailsState();
}

class _WorkoutBarbellOverheadPressDetailsState extends State<WorkoutBarbellOverheadPressDetails> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset(
        'images/shoulder/barbell_overhead_press.mp4');
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Stand with feet shoulder width apart. Hold the barbell in front of your shoulders with hands slightly wider than shoulder width apart and palms facing forward.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Do not rest the barbell on your shoulder.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
