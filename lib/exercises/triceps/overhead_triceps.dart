...
class WorkoutOverHeadDetails extends StatefulWidget {
  const WorkoutOverHeadDetails({Key? key}) : super(key: key);

  @override
  _WorkoutOverHeadDetailsState createState() =>
      _WorkoutOverHeadDetailsState();
}

class _WorkoutOverHeadDetailsState extends State<WorkoutOverHeadDetails> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Stand with feet shoulder width apart. Hold a dumbbell using both hands behind the back of your head with arms bent and elbows lifted.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
