...
class WorkoutHangingLegRaiseDetails extends StatefulWidget {
  const WorkoutHangingLegRaiseDetails({Key? key}) : super(key: key);

  @override
  _WorkoutHangingLegRaiseDetailsState createState() =>
      _WorkoutHangingLegRaiseDetailsState();
}

class _WorkoutHangingLegRaiseDetailsState extends State<WorkoutHangingLegRaiseDetails> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset(
        'images/abs/hanging_leg_raise.mp4');
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Exhale and squeeze your abs to raise your legs until they are \nparallel to the floor.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Do not shrug your shoulders when pulling.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
