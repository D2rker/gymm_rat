...
class WorkoutBarbellSquatDetails extends StatefulWidget {
  const WorkoutBarbellSquatDetails({Key? key}) : super(key: key);

  @override
  _WorkoutBarbellSquatDetailsState createState() =>
      _WorkoutBarbellSquatDetailsState();
}

class _WorkoutBarbellSquatDetailsState extends State<WorkoutBarbellSquatDetails> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Stand with feet shoulder width apart. Hold the bar on the back of your shoulders with hands slightly wider than shoulder width apart and palms facing forward.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
