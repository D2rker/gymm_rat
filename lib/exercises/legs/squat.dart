...
class WorkoutSquatDetails extends StatefulWidget {
  const WorkoutSquatDetails({Key? key}) : super(key: key);

  @override
  _WorkoutSquatDetailsState createState() =>
      _WorkoutSquatDetailsState();
}

class _WorkoutSquatDetailsState extends State<WorkoutSquatDetails> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Stand with feet shoulder width apart. Keep your arms straight and parallel to the floor in front of your body.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
