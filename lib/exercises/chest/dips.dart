...
class WorkoutDipsDetails extends StatefulWidget {
  const WorkoutDipsDetails({Key? key}) : super(key: key);

  @override
  _WorkoutDipsDetailsState createState() =>
      _WorkoutDipsDetailsState();
}

class _WorkoutDipsDetailsState extends State<WorkoutDipsDetails> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Keep your torso upright with your feet crossed below the body. Hold a bar in each hand with your arms straight and elbows slightly flared.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Bend your elbows and tilt forward to lower yourself until \nyour upper arms are parallel to the floor.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
            ...
            const Padding(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    'Pause for a few seconds and push yourself up to the \nstarting position slowly and repeat.',
                    style: TextStyle(
                      fontSize: 15.0,
                      color: Colors.black,
                    ),
