...
class WorkoutInclineBenchPressDetails extends StatefulWidget {
  const WorkoutInclineBenchPressDetails({Key? key}) : super(key: key);

  @override
  _WorkoutInclineBenchPressDetailsState createState() =>
      _WorkoutInclineBenchPressDetailsState();
}

class _WorkoutInclineBenchPressDetailsState extends State<WorkoutInclineBenchPressDetails> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset(
        'images/chest/incline_bench_press.mp4');
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Lie on the bench with feet on the floor. Hold a barbell above your chest with elbows bent at 90 degrees and palms facing forwards.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
