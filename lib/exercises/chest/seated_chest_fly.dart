...
class WorkoutSeatedChestFlyDetails extends StatefulWidget {
  const WorkoutSeatedChestFlyDetails({Key? key}) : super(key: key);

  @override
  _WorkoutSeatedChestFlyDetailsState createState() =>
      _WorkoutSeatedChestFlyDetailsState();
}

class _WorkoutSeatedChestFlyDetailsState extends State<WorkoutSeatedChestFlyDetails> {
  ...
  void initState() {
    ...
    _videoPlayerController = VideoPlayerController.asset(
        'images/chest/seated_chest_fly.mp4');
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 16.0),
              child: Text(
                'Sit on the machine with back supported and feet on the floor. Hold the handles with palms facing forward.',
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.black,
                ),
